...
import { BLOCK_SIZE, DOG_CONSTANTS } from '../constants';

export const dogVertexShader = /* wgsl */`
${uniformsStruct}
...
const ISO_ANGLE_Y: f32 = ${DOG_CONSTANTS.isoAngleY.toFixed(6)};
const ISO_ANGLE_X: f32 = ${DOG_CONSTANTS.isoAngleX.toFixed(6)};
const FLAT_ANGLE_Y: f32 = ${DOG_CONSTANTS.flatAngleY.toFixed(6)};
const FLAT_ANGLE_X: f32 = ${DOG_CONSTANTS.flatAngleX.toFixed(6)};
const VIEW_SCALE_3D: f32 = ${DOG_CONSTANTS.viewScale3D.toFixed(6)};
const VIEW_SCALE_2D: f32 = ${DOG_CONSTANTS.viewScale2D.toFixed(6)};
const Y_OFFSET_3D:   f32 = ${DOG_CONSTANTS.yOffset3D.toFixed(6)};
const X_OFFSET_3D:   f32 = ${DOG_CONSTANTS.xOffset3D.toFixed(6)};
const Y_OFFSET_2D:   f32 = ${DOG_CONSTANTS.yOffset2D.toFixed(6)};
const X_OFFSET_2D:   f32 = ${DOG_CONSTANTS.xOffset2D.toFixed(6)};
